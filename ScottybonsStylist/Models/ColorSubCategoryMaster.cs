...
namespace ScottybonsStylist.Models
{
    ...
    public partial class ColorSubCategoryMaster
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public ColorSubCategoryMaster()
        {
            this.ArticleColors = new HashSet<ArticleColor>();
        }
    
        public int ColorSubCategoryID { get; set; }
        public int ColorCategoryID { get; set; }
        public string ColorSubCategoryName { get; set; }
